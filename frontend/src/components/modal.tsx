    ...
    <>
      {modal && (
        <div
          ...
          aria-modal="false"
        >
          <div className="fixed inset-0 bg-fuchsia-800/50 bg-opacity-75 transition-opacity"></div>
            ...
            <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
              <div className="relative transform overflow-hidden rounded-lg bg-light text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
                ...
                <div className="bg-light px-4 py-3 dark:bg-dark sm:flex sm:flex-row-reverse sm:px-6">
                  ...
                  <button
                    type="button"
                    className="active:scale-click mt-3 inline-flex w-full justify-center rounded-md bg-light px-3 py-2 text-sm font-semibold text-light-primary shadow-sm ring-1 ring-inset ring-fuchsia-300 hover:bg-fuchsia-200 dark:bg-dark dark:text-dark-primary dark:hover:bg-dark-secondary/25 sm:mt-0 sm:w-auto"
                    onClick={() => {
                      setModal(false);
                    }}
                  >
