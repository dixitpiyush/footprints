  ...
  return (
    ...
    >
      ...
      <div className="mb-4 w-full sm:mb-0 sm:w-1/3">
        <Skeleton
          className="h-50 w-full rounded-lg bg-fuchsia-200 object-cover shadow-lg dark:bg-fuchsia-700 sm:h-full"
          style={{ height: '190px' }}
        />
      </div>
      ...
      <div className="flex flex-col p-3 sm:w-2/3">
        {/* Title */}
        <Skeleton className="mb-3 h-6 w-full bg-fuchsia-200 dark:bg-fuchsia-700" />
        ...
        {/* Description */}
        <Skeleton className="mb-4 h-10 w-full bg-fuchsia-200 dark:bg-fuchsia-700 sm:h-16 lg:h-16" />
