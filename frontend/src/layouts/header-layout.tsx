...
function header() {
  ...
  return (
    <div className="relative -mt-2 h-[460px] bg-[url('./assets/footprintsbg.webp')] bg-cover bg-fixed bg-center">
      ...
      <div className="absolute inset-0 flex flex-col px-4 py-8 text-slate-50 md:px-16">
        <div className="flex w-full justify-between">
          ...
          <div className="flex justify-between px-2">
            ...
            <button
              className="active:scale-click hidden rounded border border-fuchsia-50 px-4 py-2 hover:bg-fuchsia-500/25 md:inline-block"
              onClick={() => {
                navigate('/add-blog');
              }}
            >
            ...
            <button
              className="px-2 py-2 hover:bg-fuchsia-500/25 md:hidden"
              onClick={() => {
                navigate('/add-blog');
              }}
            >
