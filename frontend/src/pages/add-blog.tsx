...
function AddBlog() {
  ...
  function Asterisk() {
    return <span className="dark:text-dark-primary">*</span>;
  }

  return (
    <div className="flex-grow cursor-default bg-fuchsia-50 px-6 py-8 dark:bg-dark">
        ...
        <form onSubmit={handleSubmit} className="md:w-5/6 lg:w-2/3">
          <div className="mb-2 flex items-center">
            <label className="flex items-center">
              <span className="px-2 text-base font-medium text-light-secondary dark:text-dark-card">
          ...
          <div className="mb-2">
            <div className="px-2 py-1 font-medium text-light-secondary dark:text-dark-card">
              Blog title <Asterisk />
            </div>
            <input
              type="text"
              ...
              autoComplete="off"
              className="w-full rounded-lg bg-fuchsia-200 p-3 placeholder:text-sm placeholder:text-light-tertiary dark:bg-dark-card dark:text-fuchsia-50 dark:placeholder:text-dark-primary"
          ...
          <div className="mb-4 flex justify-between gap-2 md:gap-4">
            <input
              ...
              autoComplete="off"
              className="w-3/4 rounded-lg bg-fuchsia-200 p-3 placeholder:text-sm placeholder:text-light-tertiary dark:bg-dark-card dark:text-fuchsia-50 dark:placeholder:text-dark-primary lg:w-10/12"
              value={formData.imageLink}
              onChange={handleInputChange}
            />
            <button
              type="button"
              className="lg:text-md active:scale-click lg:pytertext-dark-tertiary3 w-1/4 rounded-lg bg-light-primary text-xs text-fuchsia-50 hover:bg-light-primary/80 dark:bg-dark-primary dark:text-dark-card dark:hover:bg-dark-secondary/80 md:text-sm lg:w-2/12 lg:px-4"
              onClick={() => {
                setmodal(true);
              }}
            >
          ...
          <div className="mb-4 flex flex-col">
            <label className="px-2 pb-1 font-medium text-light-secondary dark:text-dark-card md:mr-4 md:w-fit">
              Categories
              <span className="text-xs tracking-wide text-dark-tertiary">
                &nbsp;(max 3 categories)&nbsp;
              </span>
